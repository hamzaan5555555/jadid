    ...
    return (
        <div className="flex items-center justify-center bg-neutral-100 px-8 py-24 text-neutral-800">
            <BlockInTextCard
                ...
                text={
                    <>
                        <strong>Tu as une question ?</strong> Nous serions ravis de vous aider ! Contactez le support pour tout problème que vous pourriez rencontrer.
                    </>
                }
                examples={[
                    "est ce que vous faite livraison?",
                    "ou se trouvr arganapistash?",
